...
if ( window.location.pathname === '/' ) {     // This conditional allows the following coding block to only run if in the Homepage
  ...
  function toogleCSS (e) {
    ...
    if (e.target.tagName === 'BUTTON') {
      ...
      if (toogle === 0) {
        ...
        toogleButton.textContent = "Switch to the new design";
        toogle = 0;
      }
    }
    return;
